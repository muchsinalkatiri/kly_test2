...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<form class="user" action="{{ action('DataController@update_proses') }}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
			<div class="row">
				<div class="col-sm-8">
					<div class="form-group row">
						<div class="col-sm-6 mb-3 mb-sm-0">
							...
							<input required type="hidden" class="form-control form-control-user" value="{{ $nama_file}}" id="nama_file" placeholder="Nama" name="nama_file">
							<input required type="text" class="form-control form-control-user" value="{{ $nama}}" id="nama" placeholder="Nama" name="nama">
						</div>
						<div class="col-sm-6">
							...
							<input required type="email" class="form-control form-control-user" value="{{ $email }}" id="email" name="email" placeholder="Email">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-6 mb-3 mb-sm-0">
							...
							<input required type="text" class="time form-control form-control-user "  id="tanggallahir" value="{{ $tanggallahir }}" name="tanggallahir" placeholder="Tanggal Lahir (YYYY-mm-dd)">
						</div>
						<div class="col-sm-6" >
							...
							<input required type="text"  name="notlp" id="notlp" value="{{ $notlp  }}" class="form-control-user form-control"  placeholder="No tlp" />
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-6 mb-3 mb-sm-0">
						...
						<div class="col-sm-6 ">
							...
							<input   type="hidden"  name="foto_temp" id="foto_temp" value="{{$foto}} "  class=" form-control form-control-user"  />
						</div>
					</div>
					<hr>
					<div class="form-group row">
