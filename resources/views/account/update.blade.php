...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		@foreach($users as $u)
		<form class="user" action="{{ action('AccountController@update_proses') }}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
			<input type="hidden" class="form-control form-control-user mb-1" required  id="id" placeholder="Id" name="id" value="{{ $u->id }}">
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group row">
						...
						<input type="text" class="form-control form-control-user mb-1" required  id="name" placeholder="Name" name="name" value="{{ $u->name }}">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group row">
						...
						<input type="email" class="form-control form-control-user mb-1" required  id="email" placeholder="Email" name="email" value="{{ $u->email }}">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group row">
